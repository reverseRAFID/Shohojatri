      ...
      <nav role="navigation" class="navbar navbar-custom navbar-fixed-top">
          ...
          <div class="container-fluid">
              ...
              <div class="navbar-header">
                  ...
                  <a class="navbar-brand">Shohojatri</a>
              ...
              <div class="navbar-collapse collapse" id="navbarCollapse">
                  <ul class="nav navbar-nav" id= "glow">
...
<!--Container-->
      <div class="container" id="container">
          <div class="row">
              <div class="col-md-offset-3 col-md-6">
                  ...
                  <h2 id = "glow">General Account Settings:</h2>
                  <div class="table-responsive">
                      <table class="table table-hover table-condensed table-bordered">
                          <tr data-target="#updateusername" data-toggle="modal">
                              <td id ="glow">Username</td>
                              <td id ="glow"><?php echo $username; ?></td>
                          </tr>
                          <tr data-target="#updateemail" data-toggle="modal">
                              <td id ="glow">Email</td>
                              <td id ="glow"><?php echo $email ?></td>
                          </tr>
                          <tr data-target="#updatepassword" data-toggle="modal">
                              <td id ="glow">Password</td>
                              <td id ="glow">Click to change the Password</td>
                          </tr>
                      </table>
    ...
    <!--Update username-->    
      <form method="post" id="updateusernameform">
        <div class="modal" style="margin-top: 100px;" id="updateusername" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <!--Update email-->    
      <form method="post" id="updateemailform">
        <div class="modal" style="margin-top: 100px;" id="updateemail" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button class="close" data-dismiss="modal">
    ...
    <!--Update password-->    
      <form method="post" id="updatepasswordform">
        <div class="modal" style="margin-top: 100px;" id="updatepassword" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button class="close" data-dismiss="modal">
      ...
      <form method="post" enctype="multipart/form-data" id="updatepictureform">
        <div class="modal" style="margin-top: 100px;" id="updatepicture" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button class="close" data-dismiss="modal">
    ...
    <!-- Footer-->
      <div class="footer">
          <div class="container">
          <p id= "glow">You can change you Username, Email and Password here!</p>
          </div>
      </div>
      <!--Spinner-->
      <div id="spinner">
