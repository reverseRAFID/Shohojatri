...
$array = array("trip_id"=>$row['trip_id'], "departure"=>$row['departure'], "destination"=>$row['destination'], "price"=>$row['price'], "splitfare" =>$row['splitfare'], "seatsavailable"=>$row['seatsavailable'], "regular"=>$row['regular'], "date"=>$row['date'], "time"=>$row['time'], "monday"=>$row['monday'], "tuesday"=>$row['tuesday'], "wednesday"=>$row['wednesday'], "thursday"=>$row['thursday'], "friday"=>$row['friday'], "saturday"=>$row['saturday'], "sunday"=>$row['sunday']);
