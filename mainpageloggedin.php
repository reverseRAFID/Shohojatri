...
<!--Container-->                      
        ...
        <div class="modal"  id="addtripModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              ...
              <div class="modal-body">
                  ...
                  <!--Google Map-->
                  <div style="width: 80%;" id="googleMap"></div>
                ...
                <div class="form-group">
                    <label for="splitfare" class="sr-only">Amount to be split:</label>
                    <input type="number" name="splitfare" id="splitfare" placeholder="Amount to be split" class="form-control">
                </div>
                <div class="form-group">
      ...
      <form method="post" id="edittripform">
        <div class="modal" style="margin-top: 100px;" id="edittripModal" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button class="close" data-dismiss="modal">
    ...
    <!-- Footer-->
      <div class="footer">
          <div class="container">
          <p id= "glow">Add your trips here!</p>
          </div>
      </div>
